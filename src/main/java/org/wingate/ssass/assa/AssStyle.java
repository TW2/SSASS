...
public class AssStyle implements Cloneable {
    ...
    public String resetToOverrides() throws AssColorException {
        StringBuilder sb = new StringBuilder();

        sb.append("\\fn").append(assFont.getFont().getName());
        sb.append("\\fs").append(assFont.getFont().getSize2D());
        sb.append("\\b").append(assFont.isBold() ? 1 : 0);
        sb.append("\\i").append(assFont.isItalic() ? 1 : 0);
        sb.append("\\u").append(assFont.isUnderline() ? 1 : 0);
        sb.append("\\s").append(assFont.isStrikeout() ? 1 : 0);
        sb.append("\\bord").append(getOutline());
        sb.append("\\shad").append(getShadow());
        sb.append("\\fscx").append(getScaleX() * 100d);
        sb.append("\\fscy").append(getScaleY() * 100d);
        sb.append("\\fsp").append(getSpacing());
        sb.append("\\frz").append(getAngleZ());
        String c1 = AssColor.withScheme(getTextColor().getColor(), AssColor.Scheme.BGR);
        String c2 = AssColor.withScheme(getKaraokeColor().getColor(), AssColor.Scheme.BGR);
        String c3 = AssColor.withScheme(getOutlineColor().getColor(), AssColor.Scheme.BGR);
        String c4 = AssColor.withScheme(getShadowColor().getColor(), AssColor.Scheme.BGR);
        sb.append("\\1c").append(c1.toUpperCase());
        sb.append("\\2c").append(c2.toUpperCase());
        sb.append("\\3c").append(c3.toUpperCase());
        sb.append("\\4c").append(c4.toUpperCase());
        String a1 = Integer.toString(255 - getTextColor().getColor().getAlpha(), 16);
        String a2 = Integer.toString(255 - getKaraokeColor().getColor().getAlpha(), 16);
        String a3 = Integer.toString(255 - getOutlineColor().getColor().getAlpha(), 16);
        String a4 = Integer.toString(255 - getShadowColor().getColor().getAlpha(), 16);
        a1 = (a1.length() == 1 ? "0" : "").concat(a1).toUpperCase();
        a2 = (a2.length() == 1 ? "0" : "").concat(a2).toUpperCase();
        a3 = (a3.length() == 1 ? "0" : "").concat(a3).toUpperCase();
        a4 = (a4.length() == 1 ? "0" : "").concat(a4).toUpperCase();
        sb.append("\\1a&H").append(a1).append("&");
        sb.append("\\2a&H").append(a2).append("&");
        sb.append("\\3a&H").append(a3).append("&");
        sb.append("\\4a&H").append(a4).append("&");
